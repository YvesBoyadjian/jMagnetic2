    ...
    static {
        if (QuaquaManager.isOSX() ||
            ...
            defaultUserItems = new File[]{
        		        ...
        		        (QuaquaManager.getOS() == QuaquaManager.SOLARIS)) {
            defaultUserItems = new File[]{
                        new File(QuaquaManager.getProperty("user.home"), UIManager.getString("FileChooser.desktopFolder")),
                        new File("/media"),
                        new File(QuaquaManager.getProperty("user.home"), UIManager.getString("FileChooser.documentFolder")),
                        new File(QuaquaManager.getProperty("user.home"))
                    };
        } else {
            defaultUserItems = new File[]{
